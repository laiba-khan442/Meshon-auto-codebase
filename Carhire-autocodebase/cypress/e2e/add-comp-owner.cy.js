...
describe('It navigates to settings and creates a company type owner when all necessary fields are filled', () => {
 it('passes', () => {
    cy.loginAsAdmin(); 
    ...
    cy.get("#email").type("Test.company" + rand + "@gmail.com"); 
    ...
    cy.get("#acn").type("123456789"); 
    cy.get("#abn").type("123456789"); 
    cy.get("#company_contact_person", {timeout: 5000})
      .should("be.visible")
      .select("1", {force: true}); 
